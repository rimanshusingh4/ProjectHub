...
function Home() {
    ...
    useEffect(() => {
        const fetchProjects = async () => {
            try {
                ...
                console.log("Data in home page use effect",data)
    ...
    useGSAP(()=>{
        gsap.from(".left .card", {x:-100,duration:0.5,opacity: 0,stagger:0.3, scale: 0.1})
        gsap.from(".right .card", {x:100,duration:0.5,opacity: 0,stagger:0.8, scale: 0.1})
    },[])
                ...
                <div className='w-screen h-screen flex justify-between items-center'>
                    ...
                    <div className='gap-12 content w-3/6 h-auto my-12 flex flex-col justify-center'>
                        <div>
                            ...
                            <span className='text-lg font-normal'>Loved by 1,000+ Creators</span></h1>
                        </div>
                        <div className='flex justify-center items-center flex-col'>
                            <h1 className='text-[90px] text-center font-pac'>Fund someone's creative works</h1>
                            <p className='text-2xl font-light text-center font-abel'>Accept support. Buy Project. Setup a shop and Enviroment. It’s easier than you think.</p>
                        </div>
                        <div className='flex flex-col justify-center items-center font-abel-regular font-bold gap-2'>
                            <Link to="/admin">
                                <p className='text-2xl font-medium text-center py-6 px-12 rounded-full bg-[#FEDE00] hover:scale-105 duration-200 hover:shadow-lg'>Start Support's</p>
                            </Link>
